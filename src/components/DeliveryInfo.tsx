      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Wir liefern, bauen auf und holen wieder ab – ganz ohne Stress für
            euch!
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-card rounded-2xl border-2 border-accent p-8 text-center">
            ...
            <p className="text-muted-foreground">
              Im Umkreis von{" "}
              <span className="font-bold text-accent">10 km</span> um Brühl
              liefern wir komplett kostenlos!
            </p>
          </div>
          ...
          <div className="bg-card rounded-2xl border-2 border-secondary p-8 text-center">
            ...
            <p className="text-muted-foreground">
              Über 10 km:{" "}
              <span className="font-bold text-secondary">5€ pro Kilometer</span>{" "}
              extra. Wir kommen bis zu 100 km weit!
            </p>
          </div>
          ...
          <div className="bg-card rounded-2xl border-2 border-primary p-8 text-center">
            ...
            <p className="text-muted-foreground">
              Lieferung, Aufbau, Einweisung & Abbau – alles inklusive. Ihr
              feiert, wir kümmern uns!
            </p>
          </div>
        </div>
      </div>
