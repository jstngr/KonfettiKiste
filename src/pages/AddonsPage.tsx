...
const addons = [
  {
    ...
    emoji: "📸",
    description:
      "Professionelle DSLR Fotobox mit Sofortdruck – Spaß und Erinnerungen für Ihre Gäste.",
  },
  {
    ...
    emoji: "🎈",
    description:
      "Ein eleganter Ballonbogen als atemberaubender Hingucker für Fotos und Dekoration.",
  },
  {
    ...
    emoji: "🖼️",
    description:
      "Stilvoller Hintergrund für perfekte Erinnerungsfotos mit professionellem Look.",
  },
  {
    ...
    emoji: "🍿",
    description:
      "Frisches Popcorn – der Duft allein sorgt schon für gute Laune bei Groß und Klein.",
  },
  {
    ...
    emoji: "🍭",
    description:
      "Fluffige, süße Zuckerwatte – ein magisches Erlebnis für kleine und große Naschkatzen.",
  },
  {
    ...
    emoji: "🎊",
    description:
      "Buntes Konfetti-Set für den perfekten Party-Moment voller Farbe und Freude.",
  },
  {
    ...
    emoji: "🎨",
    description:
      "Personalisiertes Fotodesign mit Ihrem Namen, Logo oder Motto auf jedem Ausdruck.",
  },
];
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl md:text-6xl font-bold font-display mb-4">
              Zusätzliche{" "}
              <span className="text-gradient-party">Highlights</span> für Ihre
              Feier
            </h1>
      ...
      <section className="py-20 px-4 bg-muted/50">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Entdecken Sie unsere Party Pakete und fügen Sie Ihre
            Lieblings-Extras hinzu.
          </p>
