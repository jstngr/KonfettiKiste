        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Von der professionellen Photo Booth bis zum komplett organisierten Partypaket – wir machen Ihre Feier unvergesslich.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-card rounded-2xl border-2 border-border p-8 text-center hover:-translate-y-2 hover:shadow-card-hover transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold font-display mb-3">Photo Booth</h3>
              <p className="text-muted-foreground mb-6">
                Professionelle DSLR Photo Booth mit Sofortdruck – das Highlight jeder Feier.
              </p>
              <p className="text-2xl font-bold font-display text-primary mb-4">Ab 349€</p>
              <Button asChild className="w-full group-hover:bg-gradient-party transition-all">
                <Link to="/photo-booth">
            ...
            <div className="bg-card rounded-2xl border-2 border-border p-8 text-center hover:-translate-y-2 hover:shadow-card-hover transition-all duration-300 group">
              ...
              <h3 className="text-2xl font-bold font-display mb-3">Party Pakete</h3>
              <p className="text-muted-foreground mb-6">
            ...
            <div className="bg-card rounded-2xl border-2 border-border p-8 text-center hover:-translate-y-2 hover:shadow-card-hover transition-all duration-300 group">
              ...
              <p className="text-muted-foreground mb-6">
                Premium Extras wie Ballonbogen, Popcorn & Zuckerwatte für noch mehr Spaß.
              </p>
              <p className="text-2xl font-bold font-display text-primary mb-4">Ab 29€</p>
      ...
      <section className="py-24 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl md:text-5xl font-bold font-display mb-6">
            Bereit für eine <span className="text-gradient-party">unvergessliche</span> Feier?
          </h2>
          <p className="text-lg text-muted-foreground mb-8">
            Kontaktieren Sie uns jetzt und lassen Sie uns gemeinsam Ihre perfekte Party planen.
          </p>
          <Button
            size="lg"
