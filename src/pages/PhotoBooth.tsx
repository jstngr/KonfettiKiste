        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-primary/10 rounded-full px-5 py-2 mb-6">
              ...
              <span className="text-sm font-semibold text-primary">Unser Kernprodukt</span>
            </div>
            <h1 className="text-4xl md:text-6xl font-bold font-display mb-6">
              Das KonfettiKiste <span className="text-gradient-party">Photo Booth</span> Erlebnis
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Unsere professionelle DSLR Photo Booth sorgt für Spaß, Emotionen und unvergessliche Erinnerungen. Ihre Gäste können hochwertige Fotos aufnehmen und direkt Ausdrucke mit nach Hause nehmen.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="mt-8 bg-muted/50 rounded-2xl p-6 text-center">
                <p className="text-muted-foreground mb-4">
                  Sie möchten die Photo Booth als Teil eines Pakets? Entdecken Sie unsere Party Pakete!
                </p>
      ...
      <section className="py-20 px-4 bg-muted/50">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-muted-foreground mb-8">
            Sichern Sie sich jetzt Ihren Wunschtermin für die KonfettiKiste Photo Booth.
          </p>
          <Button
            size="lg"
